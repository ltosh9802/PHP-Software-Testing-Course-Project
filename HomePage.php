...
?></div>
  ...
  <tr>
    <td height="38" colspan="3">
		...
		<a style="margin-left:50px" href="HomePage.php?chk=vprofile">EDIT PROFILE</a>
		
		<a style="margin-left:50px" href="HomePage.php?chk=logout">LOGOUT</a>
				<a style="margin-left:50px" href="HomePage.php?chk=sprofile">SHOW PROFILE</a>
  ...
  <tr>
    ...
    <td width="660" valign="top">
		...
		if($coninb)
			...
			//echo "Attachement file name :".$row->attachement."<br/>";

			echo "Attachement:<br/>";
			echo "<img alt='no attachement' src='userDocuments/$id/$row->attachement' height='400' width='400'/>";  
